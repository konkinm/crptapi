...
public class CrptApiUsingLock {
    ...
    public CrptApiUsingLock(TimeUnit timeUnit, int requestLimit) {
    ...
    public static void main(String[] args) {
        CrptApiUsingLock crptApi = new CrptApiUsingLock(TimeUnit.SECONDS, 2);
        for (int i = 0; i < 10; i++) {
            final int j = i;
            new Thread(() -> {
                try {
